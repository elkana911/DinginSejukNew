...
public class ActivityMaps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button fab = findViewById(R.id.btnAddAddress);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                View view = LayoutInflater.from(ActivityMaps.this).inflate(R.layout.dialog_add_address, null);
                ...
                Util.showDialogConfirmation(ActivityMaps.this, getString(R.string.title_add_address), null, view, new ListenerPositiveConfirmation() {
                    @Override
