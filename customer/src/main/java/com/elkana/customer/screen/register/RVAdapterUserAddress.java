...
//            ((MyViewHolder) holder).tvLabelAddress.setHint(obj.getLabel());
    ...
    class MyAddAddressHolder extends RecyclerView.ViewHolder {
        ...
        public MyAddAddressHolder(View itemView) {
            ...
            btn = itemView.findViewById(R.id.btnAddAddress);
//            btn.setCompoundDrawablesWithIntrinsicBounds(Util.changeIconColor(ctx, R.drawable.ic_add_black_24dp, android.R.color.white), null, null, null);
