...
/**
 * Created by Eric on 09-Nov-17.
 * the mirror of Mitra class. dont submit to cloud, local usage only
 */
//see TmpMitra and DataUtil.cloneMitra
public class TmpMitra extends RealmObject implements Serializable {
    @PrimaryKey
    private String uid;
    private String name;
